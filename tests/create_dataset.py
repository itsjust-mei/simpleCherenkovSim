...
all_origins = []  # the track origin.    This is a list of lists for every event.
all_dirs    = []  # the track direction. This is a list of lists for every event.
all_lengths = []  # the track length.    This is a list of lists for every event.
...
for nevt in range(Nevents):
    ...
    for i in range(Ntracks):
        ...
        # chose the track length (chosen such that the endpoint is always within the detector)
        ...
        evt_origins.append(track_origin)
        evt_dirs.append(track_direction)
        evt_lengths.append(L)

    all_origins.append(evt_origins)
    all_dirs.append(evt_dirs)
    all_lengths.append(evt_lengths)
